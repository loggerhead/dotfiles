...
hi Normal	guifg=#969696 guibg=gray10 gui=none
...
hi LineNr		guifg=#509050		 guibg=grey10		gui=none term=underline ctermfg=green   
...
hi Comment		guifg=#509050		 guibg=grey10		gui=italic term=underline ctermfg=green   
hi Constant     guifg=#FF77FF        gui=none
hi Identifier   guifg=#6FDEF8        gui=none
hi Function     guifg=#82EF2A        gui=none
hi Statement    guifg=#006666        gui=none
